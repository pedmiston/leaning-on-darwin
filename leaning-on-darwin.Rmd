...
Edmiston, Perlman, & Lupyan. (in prep). Creating words from iterated vocal imitation.
...
Edmiston. (unpublished). Article quality as a selection pressure in the evolution of Wikipedia articles.
...
Edmiston, Derex, & Lupyan. (in prep). The impact of inheritance on problem solving ability.
...
Diachronic collaboration puts problem solvers in a different part of the problem space than they would have been likely to reach on their own.
